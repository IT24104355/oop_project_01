...
<div class="container">
    <div class="main-container">
        ...
        <div class="content-container">
            ...
            <p>Your inquiry has been added to the system.</p>
            <div>
                <a href="inquiry_register.jsp" class="btn btn-primary">Add Another Inquiry</a>
                <a href="inquiry_list.jsp" class="btn btn-secondary">View All Inquiries</a>
                <a href="reservation_list.jsp" class="btn btn-secondary">Reservations</a>
                <a href="table_list.jsp" class="btn btn-secondary">Tables</a>
            </div>
        </div>
    </div>
</div>
