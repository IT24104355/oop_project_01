...
<div class="container">
    <div class="main-container">
        ...
        <div class="nav-tabs">
            <ul>
                <li><a href="payment_register.jsp">Add Another Payment</a></li>
                <li><a href="payment_list.jsp" class="active">View All Payments</a></li>
                ...
                <li><a href="feedback_list.jsp">Feedback</a></li>
            </ul>
        </div>
