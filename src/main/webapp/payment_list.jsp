...
<div class="container">
    <div class="main-container">
        ...
        <div class="nav-tabs">
            <ul>
                <li><a href="registerPayment" class="active">Add Payment</a></li>
                <li><a href="listReservations">Reservations</a></li>
                <li><a href="listTables">Tables</a></li>
                <li><a href="listInquiries">Inquiries</a></li>
                <li><a href="listFeedbacks">Feedback</a></li>
            </ul>
        </div>
            ...
            <table class="table">
                ...
                <c:forEach var="payment" items="${payments}">
                    <tr>
                        ...
                        <td>
                            <a href="payment_update.jsp?paymentId=${payment.paymentId}" class="btn btn-warning btn-sm">Edit</a>
