...
<div class="container">
    <div class="main-container">
        ...
        <div class="content-container">
            <h2>Register New Inquiry</h2>
            <c:if test="${not empty error}">
                <div class="error-message">${error}</div>
            </c:if>
            <form action="registerInquiry" method="post">
            ...
            <div style="margin-top: 1.5rem; text-align: center;">
                ...
                <a href="reservation_list.jsp" class="btn btn-secondary ms-2">Reservations</a>
                <a href="table_list.jsp" class="btn btn-secondary ms-2">Tables</a>
            </div>
        </div>
    </div>
</div>
